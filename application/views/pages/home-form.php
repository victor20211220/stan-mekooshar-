<div class="col-md-12">
    <div class="white-block social">
        <h2 class="title">Register via Google</h2>
<!--        <p>-->
<!--            <a class="btn-social face" href="--><?//= Request::generateUri('socials', 'facebook'); ?><!--"-->
<!--               title="Register via Facebook network">Facebook <span class="icons i-facebook"><span></span></span></a>-->
<!---->
<!--        </p>-->
        <p>&nbsp;</p>
        <p>
            <a href="<?= Request::generateUri('socials', 'authGoogle'); ?>" class="google-btn">
            <span class="google-btn__img">
